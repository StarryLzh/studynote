...
### [#](https://javaguide.cn/cs-basics/operating-system/linux-intro.html#linux-文件系统简介)Linux 文件系统简介
...
![文件inode信息](F:\Documents\Img\文件inode信息.d9175a2d.png)
...
![Linux的目录结构](F:\Documents\Img\Linux目录树.b82202fa.png)
...
![img](F:\Documents\Img\ls -l.png)

第一列的内容的信息解释如下：

![img](F:\Documents\Img\Linux权限解读.7c1098a0.png)
